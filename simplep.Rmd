...
output:
    ...
    css: ["default", "duke-blue","chocolate-fonts"]
    lib_dir: libs
    nature:
...
Un problema con Rmarkdown es que cuando escribes el código de la presentación tienes que dar constantemente a *knitr* para previsualizar el resultado.

Esto se ha solucionado con el adding de RSTUDIO *Infinite Moon Reader*, ahora para previsualizar en tiempo real la presentación lo que hacemos es ejecutar el siguiente código y nos aparecerá en la ventana de vista la presentación con los cambios que vayamos haciendo.
...
https://github.com/gnab/remark/wiki/Formatting#video


![](https://youtu.be/LussVnrLZKU){width="560" height="315"}

<iframe width="560" height="315" src="https://youtu.be/LussVnrLZKU" frameborder="0" allow="encrypted-media" allowfullscreen></iframe>
